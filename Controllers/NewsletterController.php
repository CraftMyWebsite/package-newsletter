...
class NewsletterController extends AbstractController
{
    ...
    public function newsletterPost(): void
    {
        ...
        {
            MailController::getInstance()->sendMail($mail->getMail(), $newsletter_object, $newsletter_content . "<br><br><small><a href='".$url.$mail->getKey()."' target='_blank'>".LangManager::translate("newsletter.unsubscribe")."</a></small>");
            $i++;
        }
